...
public class TomcatServer {
	...
	public static final String CALC_URL = EXAMPLES_URL + "/calculator";
	...
	public void start() throws ServletException, LifecycleException {
		...
		config.packages("bank.rest", "books.rest", "hello", "solutions","webserver","lab5");
		...
		// Start server
		tomcat.start();
		System.out.println("aight you can start now");
